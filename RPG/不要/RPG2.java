...
public class RPG2 extends Application{
  ...
  void Dungeon(){
    ...
    Timeline t = new Timeline(
            new KeyFrame(Duration.millis(10.0),e -> MoveDungeon(e, posiflag, daniv)));
    t.setCycleCount(Timeline.INDEFINITE);
    t.play();
  ...
  void MoveDungeon(ActionEvent e, int posiflag, ImageView[] daniv){
      chara.setX(chara.getX()+movex);
      chara.setY(chara.getY()+movey);
      chara_x = chara.getX();
      chara_y = chara.getY();
  ...
  void Battle(){
    ...
    int monsterBorn, bornflag=0, hpflag=1;;
    ...
    Timeline t = new Timeline(
            new KeyFrame(Duration.millis(10.0),e -> System(e, screen, levelExp, hpflag, bornflag)));
    t.setCycleCount(Timeline.INDEFINITE);
    t.play();
    ...
    BattleScene.setOnMousePressed(event -> Command(event, screen, slime, goblin, 
            hpflag, bornflag, monsterBorn, magicCommand, tokugiCommand, monsterImage));
    stage.setScene(BattleScene);
  }

  void System(ActionEvent e, Group screen, int[] levelExp, int hpflag, int bornflag){
  ...
  void Command(MouseEvent e, Group screen, SlimeStatus[] slime, GoblinStatus[] goblin, 
            int hpflag, int bornflag, int monsterBorn, Group magicCommand, Group tokugiCommand, HBox monsterImage){

      int magicflag=0, tokugiflag=0, runflag=0;
      ...
      if(mouse_x >= 0 && mouse_x <= 200){
          ...
          if(mouse_y >= 250 && mouse_y <= 300){
              ...
              tokugiflag = 0;
              magicflag = 0;
              Attack(monsterBorn, bornflag, slime, goblin, monsterImage);
              //wait(1);
              AttackEnemy(hpflag, slime, goblin);
          }
      ...
      if(mouse_x >= 250 && mouse_x <= 700 && mouse_y >= 250 && mouse_y <= 450){
          if(magicflag == 1){
              Magic(e, slime, goblin);
              AttackEnemy(hpflag, slime, goblin);
          }
          if(tokugiflag == 1){
              Tokugi(e, slime, goblin);
              AttackEnemy(hpflag, slime, goblin);
          }
      }
  ...
  void Inshitsu(SlimeStatus[] slime, GoblinStatus[] goblin){
  ...
  void Magic(MouseEvent e, SlimeStatus[] slime, GoblinStatus[] goblin){
      double mouse_x, mouse_y;
      mouse_x = e.getX();
      mouse_y = e.getY();
  ...
  void Tokugi(MouseEvent e, SlimeStatus[] slime, GoblinStatus[] goblin){
      double mouse_x, mouse_y;
      mouse_x = e.getX();
      mouse_y = e.getY();
      if(mouse_x >= 250 && mouse_x <= 450 && mouse_y >= 250 && mouse_y <= 300)
          Inshitsu(slime, goblin);
  }
  ...
  void Attack(int monsterBorn, int bornflag, SlimeStatus[] slime, GoblinStatus[] goblin, HBox monsterImage){
  ...
  void AttackEnemy(int hpflag, SlimeStatus[] slime, GoblinStatus[] goblin){
